...
/** De ranglijst "beste rijscholen in ..." voor een stad. */
export function ranglijstUrl(stad: string): string {
  return `https://ribba.nl/rijscholen/beste-rijscholen-in-${stadSlug(stad)}`;
}
